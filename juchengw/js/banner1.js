$(function() {
    ...
    var Right = $('.next');
    var Ul = $('.banner-list'); // alert(Ul.length);
    //console.log(Ul)
    var Width = $('.banner-list a').width(); //alert(Width);
    var bannerLength =$(".banner-list a").length;
   // console.log(bannerLength)
    ...
    Right.on('click', function() {
        ...
        if (Index == bannerLength-1) {
            ...
            Point.eq(0).addClass('banner-active').siblings().removeClass('banner-active');

        } else {
            Point.eq(Index).addClass('banner-active').siblings().removeClass('banner-active');
        }
